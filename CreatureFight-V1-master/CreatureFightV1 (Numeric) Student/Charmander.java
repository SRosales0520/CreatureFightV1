...
public class Charmander extends Creature
{
    ...
    public void act() 
    {
        ...
        {
            //TODO (44): Get the world and use it to show text that says that Charmander has fainted at an x location of getWorld().getWidth()/2 and a y location of getWorld().getWidth()/2
            getWorld().showText("Charmander has Fainted!", getWorld().getWidth()/2, getWorld().getWidth()/2);
